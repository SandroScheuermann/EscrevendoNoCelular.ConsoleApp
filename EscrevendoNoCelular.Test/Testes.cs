...
namespace EscrevendoNoCelular.Test
{
    ...
    public class Testes
    {
        ...
        {
            Assert.AreEqual("ERRO : PASSOU DOS LIMITES DE CARACTERES!", transforma.RetornaQwerty(""));
        }
    }
}
